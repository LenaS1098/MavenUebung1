...
public class DBAccess {
	...
	public static void main(String[] args) {
		...
		System.out.println("Hotel Buchungssystem:");
		while(loop == 1){
			System.out.println("Geben Sie ein Suchwort ein:");
			String suchwort = scanner.nextLine();
			System.out.println("");
			System.out.println("Waehlen Sie den Suchmodus mittels Eingabe der bestimmten Zahl");
			System.out.println("[1] -> Einfache Hotelsuche");
			System.out.println("[2] -> Hotelsuche via Cache");
			System.out.println("Ihre Eingabe: ");
			int input = scanner.nextInt();

			switch (input){
				case 1:
					proxy.getHotelByName(suchwort);
					break;
				case 2:
					proxy.getHotelViaCache(suchwort);
					break;
				default:
			...
			System.out.println("");
			System.out.println("[1] Neue Suche ; [2] Beenden");
